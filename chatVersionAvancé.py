...
class Serveur:
	...
	list = ""
        while 1:
			...
			self.listConn.append(conn) #on ajoute les connections des sockets
			...
			print("Chaine de nicknames et IPs ", listNickIPs)
			    ...
			    if count != len(self.connection):
			        list = list + ","
                        ...
                        self.ips(addr, conn, listNickIPs)
	...
	socks=[s]
        ...
        while 1:
			...
			if(len(contenu)>1):
				    ...
				    #Liste de nicknames et IPs
				    namesIPs = contenu_commande[1].split(",")
				    

			 	    #La liste de nicknames et la liste d'IPs
				    for ni in namesIPs:
